...
<div id="search">
  ...
  <div id="search-button">
    <input type="image" name="op" value="search" id="edit-submit-2" src="<?php print base_path() . $directory; ?>/images/search-arrow.png" class="searchButtonPng"  alt="<?php print t('Search') ?>" />
  </div>
