<?php
// $Id: page.tpl.php,v 1.1 2010/12/14 18:00:40 marianojofre Exp $
?>
    ...
    <div id="page-inner" class="page-inner">
      ...
      <div id="header-group-wrapper" class="header-group-wrapper full-width">
        <div id="header-group" class="header-group row <?php print $grid_width; ?>">
          <div id="header-group-inner" class="header-group-inner inner clearfix"><?php print theme('grid_block', $primary_links_tree, 'primary-menu'); ?> <?php print theme('grid_block', theme('links', $secondary_links), 'secondary-menu'); ?>
          ...
          <?php print $header; ?><?php print theme('grid_block', $search_box, 'search-box'); ?></div>
          <!-- /header-group-inner -->
        </div><!-- /header-group -->
        ...
        <div id="footer-message" class="footer-message row <?php print $grid_width; ?>">
          <div id="footer-message-inner" class="footer-message-inner inner clearfix">
            <?php print theme('grid_block', $footer_message, 'footer-message-text'); ?>
             <a href="http://www.drupalsoul.com/en/drupal-themes">Drupal Themes</a> by <a href="http://www.glidea.com">Web Agency</a>
